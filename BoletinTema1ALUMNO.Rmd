...
author: "Candela Santandreu Polop"
...
diferentes1 <- setdiff(rownames(df1), rownames(df2))
diferentes1

#animales en animals2 pero no en mammals
diferentes2 <- setdiff(rownames(df2), rownames(df1))
diferentes2
...
#aparecen escritos de manera diferente
...
#c
length(libReturn$results) #tengo 702 librerias
...
```{r}
levels(cabbages$Cult) #dos  variables, una c39 y otra c52
